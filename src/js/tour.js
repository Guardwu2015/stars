var GALAXY_TOUR = [{
  ...
  travelTime: 5000,
  restTime: 4000,
  message: 'This is the Sun, our home star.'
},
{
  ...
  travelTime: 4000,
  restTime: 3000,
  message: 'It would take 18 years for a jet airplane to fly to the sun.',
  callback: displaySunEarthDiagram
},
{
  rx: 0.8369933670834534,
  ry: 1.837770087331788,
  z: 30.937978822676058,
  travelTime: 4000,
  restTime: 5000,
  message: 'The furthest man-made object, Voyager 1, is now almost 17 light hours away.'
},
{
  rx: 0.6424544063335803,
  ry: -0.0031800804774647718,
  z: 198.23179619362583,
  travelTime: 3000,
  restTime: 5000,
  message: 'This is the length of one light year, the distance that light can travel in a year.'
},
{
  rx: 0.503337952515914,
  ry: -0.9904961225532652,
  z: 432.34847195438465,
  travelTime: 4000,
  restTime: 8000,
  message: 'These are the stars closest to our solar system.<br>The nearest star system, Alpha Centauri, is 4.3 light years away.'
},
{
  ...
  travelTime: 4000,
  restTime: 5000,
  message: 'Named stars that astronomers have studied are highlighted here.'
},
{
  rx: 0.5522785678088462,
  ry: 1.324151395815386,
  z: 1672.4214873346518,
  travelTime: 5000,
  restTime: 5000,
  message: "You're seeing the actual density and location of over 100,000 stars in this view."
},
{
  ...
  travelTime: 5000,
  restTime: 5000,
  message: 'Blue, hotter burning stars reside closer to the galactic plane.',
...
},
{
  ...
  travelTime: 5000,
  restTime: 5000,
  message: 'All of which are in the Milky Way... which has 200 to 400 billion stars in total.',
...
},
{
  ...
  travelTime: 10000,
  restTime: 6000,
  message: 'Go forth and explore. Click, drag and zoom with your mouse.'
}
]
...
Tour.prototype = {
  ...
  next: function (continuous) {
    ...
    if (state.callback) { this.arrivalCallback = state.callback } else { this.arrivalCallback = undefined }
