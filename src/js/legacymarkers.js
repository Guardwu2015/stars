...
function attachLegacyMarker (text, obj, size, visibleRange) {
  ...
  marker.setVisible = function (vis) {
    ...
    if (vis) { this.style.visibility = 'visible' } else { this.style.visibility = 'hidden' }
    return this
  }
  ...
  marker.update = function () {
    ...
    if (inCamRange && inCamFrame && isParentVisible) { this.setVisible(true) } else { this.setVisible(false) }
  }
