...
function setStarModel (position, name) {
  ...
  { starModel.setSpectralIndex(0.9) } else { starModel.setSpectralIndex(mainStar.c) }
...
function getOffsetByStarRadius (radius) {
  ...
  if (radius > 6) { camera.position.target.x = constrain(0.000000025 * radius, -0.0000001, 1000) } else { camera.position.target.x = -0.00000005 }
