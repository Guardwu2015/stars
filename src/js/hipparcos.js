...
var datastarUniforms = {
  ...
  texture0: {
    type: 't',
    value: datastarTexture0
  },
  texture1: {
    type: 't',
    value: datastarTexture1
  },
  heatVisionTexture: {
    type: 't',
    value: datastarHeatVisionTexture
  },
  spectralLookup: {
    type: 't',
    value: starColorGraph
  },
  idealDepth: {
    type: 'f',
    value: 1.0
...
function generateHipparcosStars () {
  ...
  for (var i in pGeo.vertices) {
    ...
    if (p.name.length > 0) {
      ...
      preview.update = function () {
        ...
        if (this.material <= 0.0) { this.visibile = false } else { this.visible = true }
  ...
  starBases.update = function () {
    ...
    if (this.material.opacity <= 0) { this.visible = false } else { this.visible = true }
  }
  ...
  lineMesh.update = function () {
    ...
    //	some basic LOD
    if (camera.position.z < 250) { this.visible = false } else { this.visible = true }
  }
